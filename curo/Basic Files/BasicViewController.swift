...
class UserDefaultsManager {
    ...
    func savePatientId(_ userId: String) {
        userDefaults.set(userId, forKey: patientIdKey)
    }
    ...
    func getPatientId() -> String? {
        return userDefaults.string(forKey: patientIdKey)
    }

    // MARK: - Remove Data (if needed)
    func removeUserData() {
        userDefaults.removeObject(forKey: userNameKey)
        userDefaults.removeObject(forKey: patientIdKey)
    }
}
